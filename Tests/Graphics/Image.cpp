...
TEST(Image, QoI) {
    ...
    auto res_in_qoi = Stf::Gfx::Detail::Image::QoI::decode_qoi_image(std::span(vec_in_qoi));
    ...
    Stf::Gfx::Detail::Image::QoI::encode_qoi_image(back_inserter(vec_reencode_qoi), img_in_qoi);
    ...
    auto res_redecode_data = Stf::Gfx::Detail::Image::QoI::decode_qoi_image(std::span(vec_reencode_qoi));
