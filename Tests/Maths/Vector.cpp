...
TEST(Vector, BasicExpressions) {
    ...
    ASSERT_EQ(Stf::get<0>(vec_0), 1.f);
    ASSERT_EQ(Stf::get<1>(vec_0), 2.f);
    ASSERT_EQ(Stf::get<2>(vec_0), 3.f);
    ...
    ASSERT_EQ(Stf::get<0>(vec_1), 1.f);
    ASSERT_EQ(Stf::get<1>(vec_1), 1.f);
    ASSERT_EQ(Stf::get<2>(vec_1), -.5f);
